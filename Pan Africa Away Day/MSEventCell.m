...
- (void)setEvent:(Session *)event
{
    ...
    self.location.attributedText = [[NSAttributedString alloc] initWithString:event.sessionDescription attributes:[self subtitleAttributesHighlighted:self.selected]];;
}
